...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaTraces/releases/download/v0.10.0/victoria-traces-linux-amd64-v0.10.0.tar.gz
tar xzf victoria-traces-linux-amd64-v0.10.0.tar.gz
```
