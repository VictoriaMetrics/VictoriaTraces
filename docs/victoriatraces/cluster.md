...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaTraces/releases/download/v0.9.1/victoria-traces-linux-amd64-v0.9.1.tar.gz
tar xzf victoria-traces-linux-amd64-v0.9.1.tar.gz
```
