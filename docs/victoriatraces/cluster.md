...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaTraces/releases/download/v0.11.0/victoria-traces-linux-amd64-v0.11.0.tar.gz
tar xzf victoria-traces-linux-amd64-v0.11.0.tar.gz
```
