...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaTraces/releases/download/v0.9.2/victoria-traces-linux-amd64-v0.9.2.tar.gz
tar xzf victoria-traces-linux-amd64-v0.9.2.tar.gz
```
