...
const TimezonesPicker: FC = () => {
  ...
  const handleKeyDownTrigger = (e: KeyboardEvent) => {
  ...
  useEffect(() => {
    // eslint-disable-next-line @eslint-react/set-state-in-effect -- syncs local editable value to the external stateTimezone (e.g. changed elsewhere in the app)
