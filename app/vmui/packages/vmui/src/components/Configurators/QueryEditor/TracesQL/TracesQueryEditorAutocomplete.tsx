...
import { useFetchTracesQLOptions } from "./useFetchTracesQLOptions";
import { pipeList } from "./pipes";

const TracesQueryEditorAutocomplete: FC<QueryEditorAutocompleteProps> = ({
  value,
  anchorEl,
  caretPosition,
  hasHelperText,
  ...
  const { fieldNames, fieldValues, loading } = useFetchTracesQLOptions(contextData);
...
export default TracesQueryEditorAutocomplete;
