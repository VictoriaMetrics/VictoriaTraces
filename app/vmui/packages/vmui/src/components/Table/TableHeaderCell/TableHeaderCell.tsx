...
import DragResizeHandle from "../../Main/DragResizeHandle";
...
const TableHeaderCell = <T extends object>({
  ...
  const thStyle = { ...style, zIndex: isDragging ? 1000 : 100 - idx };
  ...
  }, [column, sort, isSorted, isDesc, sortable]);

  const handleResize = useCallback((width: number) => {
    onChangePref(column.key, "width", width);
  }, [column.key, onChangePref]);
