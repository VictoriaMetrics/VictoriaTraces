...
import SelectLimit from "../../Main/Pagination/SelectLimit";
...
const TableSettingsColumns: FC<TableSettingsProps> = ({
  ...
  useEffect(() => {
    const el = itemsRef.current[indexFocusItem];
    if (!el) return;
