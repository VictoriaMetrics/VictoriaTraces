...
export const useAutocompleteKeyboard = ({
  ...
  useEffect(() => {
    // eslint-disable-next-line @eslint-react/set-state-in-effect -- resets keyboard focus index whenever the options list changes, to clear a now-stale selection
