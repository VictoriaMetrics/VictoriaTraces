...
import TracesQueryEditorAutocomplete from "../../../components/Configurators/QueryEditor/TracesQL/TracesQueryEditorAutocomplete";
import { useQueryDispatch, useQueryState } from "../../../state/query/QueryStateContext";
import Switch from "../../../components/Main/Switch/Switch";
import QueryHistory from "../../../components/QueryHistory/QueryHistory";
import useBoolean from "../../../hooks/useBoolean";

export interface ExploreTraceHeaderProps {
  query: string;
  limit: number;
  error?: string;
  isLoading: boolean;
...
const ExploreTracesHeader: FC<ExploreTraceHeaderProps> = ({
  query,
  limit,
  error,
  isLoading,
  ...
  return (
    <div
      className={classNames({
        "vm-explore-traces-header": true,
        "vm-block": true,
        "vm-block_mobile": isMobile,
      })}
    >
      <div className="vm-explore-traces-header-top">
        <QueryEditor
          value={query}
          autocomplete={autocomplete}
          autocompleteEl={TracesQueryEditorAutocomplete}
      ...
      <div className="vm-explore-traces-header-bottom">
        <div className="vm-explore-traces-header-bottom-contols">
          <Switch
            label={"Autocomplete"}
            value={autocomplete}
        ...
        <div className="vm-explore-traces-header-bottom-helpful">
          <a
        ...
        <div className="vm-explore-traces-header-bottom-buttons">
          <QueryHistory
            handleSelectQuery={handleSelectHistory}
            historyKey={"TRACES_QUERY_HISTORY"}
          />
          <div className="vm-explore-traces-header-bottom-execute">
            <Button
            ...
            >
              <div>
                <span className="vm-explore-traces-header-bottom-execute__text">
                  {isLoading ? "Cancel Query" : "Execute Query"}
                </span>
                <span className="vm-explore-traces-header-bottom-execute__text_hidden">Execute Query</span>
              </div>
            </Button>
          </div>
        </div>
...
export default ExploreTracesHeader;
