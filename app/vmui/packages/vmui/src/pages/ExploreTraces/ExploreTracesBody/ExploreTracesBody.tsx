...
export interface ExploreTraceBodyProps {
  data: Traces[];
  isLoading: boolean;
}
...
const ExploreTracesBody: FC<ExploreTraceBodyProps> = ({ data, isLoading }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames({
          "vm-explore-traces-body-header": true,
          "vm-section-header": true,
          "vm-explore-traces-body-header_mobile": isMobile,
        })}
      >
        <div
          className={classNames({
            "vm-section-header__tabs": true,
            "vm-explore-traces-body-header__tabs_mobile": isMobile,
          })}
        >
          <Tabs
          ...
          {activeTab !== DisplayType.liveTailing && (
            <div className="vm-explore-traces-body-header__trace-info">
              Total traces returned: <b>{data.length}</b>
            </div>
          )}
        </div>
        <div
          className="vm-explore-traces-body-header__settings"
          ref={settingsRef}
        />
      </div>
      ...
      <div
        className={classNames({
          "vm-explore-traces-body__table": true,
          "vm-explore-traces-body__table_mobile": isMobile,
        })}
      >
        {ActiveTabComponent &&
            <ActiveTabComponent
...
export default ExploreTracesBody;
