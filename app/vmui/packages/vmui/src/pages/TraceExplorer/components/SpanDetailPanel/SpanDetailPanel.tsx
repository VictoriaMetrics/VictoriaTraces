import { CSSProperties, RefObject, useMemo, useState } from "preact/compat";
...
const SpanDetailPanel = ({ span, panelRef, width, onClose }: SpanDetailPanelProps) => {
  ...
  const { height, top } = useAvailableHeight(panelRef);
  ...
  return (
    ...
    >
      ...
      <div className="vm-span-detail-panel__content">
        ...
        <div className="vm-span-detail-panel__tab-content">
          {activeTab === "fields" && (
            <>
              <TextField
