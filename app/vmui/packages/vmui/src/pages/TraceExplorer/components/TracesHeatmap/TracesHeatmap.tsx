...
import {
  ...
  HEATMAP_ERROR_CELL_THRESHOLD,
  HEATMAP_ERROR_FALLBACK_COLOR,
...
const TracesHeatmap: FC<TracesHeatmapProps> = ({
  ...
  useEffect(() => {
    ...
    const { yAxisWidth: nextYAxisWidth } = renderIntoCanvas({
      ...
      errorColor: errorColor || HEATMAP_ERROR_FALLBACK_COLOR,
  ...
  return (
    ...
    >
      ...
      <div className="vm-traces-heatmap__legend">
        <div className="vm-traces-heatmap__legend-item">
          <span className="vm-traces-heatmap__legend-swatch vm-traces-heatmap__legend-swatch_traces"/>
          <span className="vm-traces-heatmap__legend-label">Traces</span>
        </div>
        {hasErrorCells && (
          <div className="vm-traces-heatmap__legend-item">
            <span className="vm-traces-heatmap__legend-swatch vm-traces-heatmap__legend-swatch_errors"/>
            <span className="vm-traces-heatmap__legend-label">Errors</span>
          </div>
        )}
      </div>
    </div>
